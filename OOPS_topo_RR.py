...
class fwctrl: #forwarder class
    ...
    def createLink(self, other,localMAC, remoteMAC, net=net):
        ...
        link = net.addLink(self.host, other.host, addr1=localMAC, addr2=remoteMAC, delay= '50000ms', bw=0.1)
    ...
    def loadStrategyRR(self):
        ...
        strategy = self.graphQLClient.fetch("""
                ...
                """, {
                    "elf": "",
                     "name": "ndndpdk-strategy-roundrobin.o"
                })
...
fib_ids['V_QT'] = Q.insertFibEntry_strategy('V', ['faceQS', 'faceQT'], strategyID) #idhar strategy wala method use krna hai
